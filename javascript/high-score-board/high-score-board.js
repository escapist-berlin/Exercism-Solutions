...
export function normalizeScore(params) {
  ...
  if (params.hasOwnProperty("score") && params.hasOwnProperty("normalizeFunction")) {
    playerScore = params["score"];
    normalize = params["normalizeFunction"];
    return normalize(playerScore);
  }
